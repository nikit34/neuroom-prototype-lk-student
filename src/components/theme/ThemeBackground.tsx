...
const SCENES: Record<string, ThemeScene> = {
  ...
  // K-Pop — светлая, city (неоновый Сеул)
  kpop: {
  ...
  // Genshin Impact — светлая, mountains (Тейват)
  genshin: {
  ...
  // Атака Титанов — тёмная, city (стены)
  aot: {
  ...
  // Странные дела — тёмная, forest (Изнанка)
  strangerthings: {
